...
//     });
//
//     xit('Calls onUpdate with null on start when file does not exist', () => {
//         waitsForPromise(() =>
//             new Promise((resolve) => {
//                 process.chdir(Path.join(__dirname, 'fixtures/rcFiles/noRcFile'));
//
//                 const configWatch = ConfigWatch({
//                     usePolling: true,
//                     interval: 200
...
//     });
//
//     xit('Calls onUpdate with value on start when file does exist', () => {
//         waitsForPromise(() =>
//             new Promise((resolve) => {
//                 process.chdir(Path.join(__dirname, 'fixtures/rcFiles/singleSession'));
//
//                 const configWatch = ConfigWatch({
//                     usePolling: true,
//                     interval: 200
...
//             process.chdir(Path.join(__dirname, 'fixtures/rcFiles/singleSessionCopy'));
//         });
//
//         afterEach(() => {
//             process.chdir(Path.join(__dirname, 'fixtures/rcFiles'));
